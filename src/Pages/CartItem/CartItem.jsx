              ...
              >
                <div style={{ display: "flex", width: 800 }}>
                  ...
                  <div style={{ marginLeft: 40 }}>
                    <h3>{tour.title}</h3>
                    <p style={{ fontSize: 16, margin: "3px 0" }}>
                      Mã đơn hàng: {tour.id}
                    </p>
                    <p style={{ fontSize: 16, margin: "3px 0" }}>
                      Số vé: {tour.ticket}
                    ...
                    <p style={{ fontSize: 16, margin: "3px 0" }}>
                      Chi tiết vé:
                      Người lớn: {tour.ticketArray[0]?.Adult?.quantity},
                      Trẻ em: {tour.ticketArray[0]?.Baby?.quantity},
                      Em bé: {tour.ticketArray[0]?.Baby2?.quantity}
                    </p>
                    <p style={{ fontSize: 16, margin: "3px 0" }}>
